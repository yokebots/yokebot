...
export function DocsPage() {
  ...
  useSEO({
    title: doc?.title ? `${doc.title} — Docs` : 'Documentation',
    description: doc?.description ?? 'Guides, API reference, and tutorials for deploying and managing your AI agent workforce with YokeBot.',
    path: `/docs${fullSlug !== 'getting-started' ? `/${fullSlug}` : ''}`,
  })
