...
const modelCards = [
  ...
  { icon: 'terminal', color: 'indigo', tag: 'Coding', name: 'MiMo-V2-Flash', desc: '#1 open-source SWE-bench. 309B MoE, 15B active, 262K context. Blazing fast coding.', stars: { i: 5, p: 4, s: 5 }, credits: 5 },
  { icon: 'precision_manufacturing', color: 'purple', tag: 'Agentic', name: 'MiMo-V2-Pro', desc: '78% SWE-bench, #3 ClawEval. 1T+ MoE, 42B active, 1M context. Fine-tuned for agentic tool calling.', stars: { i: 5, p: 5, s: 3 }, credits: 25 },
